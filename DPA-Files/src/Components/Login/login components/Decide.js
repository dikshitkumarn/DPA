...
const Decide = props => {
    return(
        <div className='container'>
            ...
            <Form wrongsignup={props.wrongsignup} load={props.load} option={props.option} wrong={props.wrong} Change={props.handlesignup} Change2={props.handlesignin} Submit={props.handleSubmit} signup={props.signup} signin={props.signin} />
        </div>
            // show={props.show} 
    )
}
