        ...
        <form className='account-form form-container' onSubmit={ event => this.props.Submit(event)}>
            <div className={'account-form-fields ' + (this.props.option === 1 ? 'sign-in' : 'sign-up') }>
                ...
                <Fragment>
                    ...
                    <input id='password' className="textbox" minLength="6" name='password' type='password' value={this.props.signup.password} placeholder='Password' required={true} onChange={event => this.props.Change(event)} />
                    ...
                    {this.state.showtextbox?<input name="hospital" type="text" value={this.props.signup.hospital} className="textbox" placeholder="Hospitalname" required={true} onChange={event => this.props.Change(event)} />:null}
